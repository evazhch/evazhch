...
public class Shop
{
    ...
    public static void init()
    {
        ...
        use.click_event += new Button.Click_event(click_buy);
        ...
        //under.click_event += new Button.Click_event(click_equip_under);

        shop.button = new Button[13];
        shop.button[0] = equip_att;
        shop.button[1] = equip_def;
        shop.button[2] = next_player;
        shop.button[3] = item_menu;
        shop.button[4] = skill_menu;
        shop.button[5] = previous_page;
        shop.button[6] = next_page;
        shop.button[7] = use;
        shop.button[8] = close;
        shop.button[9] = sel1;
        shop.button[10] = sel2;
        shop.button[11] = sel3;
        shop.button[12] = under;
        shop.set(58, 71, "item/status_bg.png", 9, 8);
    ...
    public static void draw(Graphics g, int x_offset, int y_offset)
    {
        ...
        //if (Statusmenu.menu == 0)
          //  g.DrawImage(bitmap_sel, x_offset + 629, y_offset + 51);
        //else
          //  g.DrawImage(bitmap_sel, x_offset + 629, y_offset + 51);
        //显示物品
        if (Statusmenu.menu == 0)
